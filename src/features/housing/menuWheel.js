...
const WheelData = Utils.Wheel.parseJson( FileLib.read(Metadata.name, 'assets/wheelHousing.json') ) 
        ...
        Object.keys(WheelData).forEach(key => {
            ...
            if (
              ...
              (mouseY > formulaCoordY - 6 && mouseY < formulaCoordY  + 22)
                ...
                const awfullylong = Utils.Wheel.colors[WheelData[key].color ? WheelData[key].color : 'blue']
